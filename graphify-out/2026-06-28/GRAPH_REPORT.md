...
## Corpus Check
- 67 files · ~48,968 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 475 nodes · 632 edges · 35 communities (29 shown, 6 thin omitted)
...
Cohesion: 0.06
Nodes (26): db, express, multer, path, { requireAdmin }, router, storage, upload (+18 more)
...
Cohesion: 0.11
Nodes (15): getThumbBuffer(), inFlight, { Jimp }, path, queue, storage, app, cors (+7 more)
...
Cohesion: 0.14
Nodes (12): Architecture, Backend, Backend (`backend/src/`), Commands, Data model, Deployment, Environment Variables, Expo Version Note (+4 more)
...
## Knowledge Gaps
- **288 isolated node(s):** `docker-entrypoint.sh script`, `name`, `version`, `main`, `start` (+283 more)
